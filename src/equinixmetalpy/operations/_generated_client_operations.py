...
def build_delete_ip_address_request(id: str, **kwargs: Any) -> HttpRequest:
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/ips/{id}")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, "str"),
    }
...
def build_find_ip_address_by_id_request(
    id: str,
    *,
    include: Optional[List[str]] = None,
    exclude: Optional[List[str]] = None,
...
def build_update_ip_address_request(id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
def build_find_ip_availabilities_request(
    id: str, *, cidr: Union[str, "_models.Enum13"], **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/ips/{id}/available")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, "str"),
    }
    ...
    # Construct parameters
    _params["cidr"] = _SERIALIZER.query("cidr", cidr, "str")
...
def build_find_ip_address_customdata_request(id: str, **kwargs: Any) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})

    accept = _headers.pop("Accept", "application/json")

    # Construct URL
    _url = kwargs.pop("template_url", "/ips/{id}/customdata")
    path_format_arguments = {
        "id": _SERIALIZER.url("id", id, "str"),
    }
...
def build_find_ip_reservation_customdata_request(
    project_id: str, id: str, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/projects/{project_id}/ips/{id}/customdata")
    path_format_arguments = {
...
def build_find_vrf_ip_reservation_request(
    vrf_id: str,
    id: str,
    *,
    include: Optional[List[str]] = None,
    ...
    **kwargs: Any
    ...
    # Construct URL
    _url = kwargs.pop("template_url", "/vrfs/{vrf_id}/ips/{id}")
    path_format_arguments = {
        "vrf_id": _SERIALIZER.url("vrf_id", vrf_id, "str"),
        "id": _SERIALIZER.url("id", id, "str"),
    }
